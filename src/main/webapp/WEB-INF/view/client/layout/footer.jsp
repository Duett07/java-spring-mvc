                        ...
                        <div class="row g-4">
                            <div class="col-lg-3">
                                <a href="#">
                                    ...
                                    <p class="text-secondary mb-0">@Du</p>
                                </a>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-item">
                                <h4 class="text-light mb-3">Chất Lượng Là Hàng Đầu</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-item">
                                ...
                                <p>Email: dulo20072006@gmail.com</p>
                                <p>Phone: 0934783937</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Du</a>,
